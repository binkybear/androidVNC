...
public class ZoomControls extends LinearLayout {
    ...
    public ZoomControls(Context context, AttributeSet attrs) {
        ...
        inflater.inflate(android.androidVNC.R.layout.zoom_controls, this, // we are the parent
                true);
        
        mZoomIn = (ZoomButton) findViewById(android.androidVNC.R.id.zoomIn);
        mZoomOut = (ZoomButton) findViewById(android.androidVNC.R.id.zoomOut);
        mZoomKeyboard = (ImageButton) findViewById(android.androidVNC.R.id.zoomKeys);
    }
